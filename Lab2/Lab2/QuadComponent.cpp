...
QuadComponent::QuadComponent(Game* g, SimpleMath::Vector3 color) : GameComponent(g), offset()
{
	SimpleMath::Vector4 pointsTmp[8] = {
	SimpleMath::Vector4(0.5f, 0.5f, 0.5f, 1.0f),	SimpleMath::Vector4(color.x, color.y, color.z, 1.0f),
	SimpleMath::Vector4(-0.5f, -0.5f, 0.5f, 1.0f),	SimpleMath::Vector4(color.x, color.y, color.z, 1.0f),
	SimpleMath::Vector4(0.5f, -0.5f, 0.5f, 1.0f),	SimpleMath::Vector4(color.x, color.y, color.z, 1.0f),
	SimpleMath::Vector4(-0.5f, 0.5f, 0.5f, 1.0f),	SimpleMath::Vector4(color.x, color.y, color.z, 1.0f),
	};
