...
TriangleComponent::TriangleComponent(Game* g, float x, float y) : GameComponent(g)
{
	points[0] = DirectX::XMFLOAT4(0.5f + x, 0.5f + y, 0.5f, 1.0f);
	points[1] = DirectX::XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f);
	points[2] = DirectX::XMFLOAT4(-0.5f + x, -0.5f + y, 0.5f, 1.0f);
	points[3] = DirectX::XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f);
	points[4] = DirectX::XMFLOAT4(0.5f + x, -0.5f + y, 0.5f, 1.0f);
