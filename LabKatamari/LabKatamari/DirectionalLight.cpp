...
Matrix DirectionalLight::GetLightSpaceMatrix(const float nearPlane, const float farPlane) const
{
...
std::vector<Matrix> DirectionalLight::GetLightSpaceMatrices() const
{
