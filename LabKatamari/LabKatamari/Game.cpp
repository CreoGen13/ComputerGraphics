...
Game::Game(LPCWSTR name, int screenWidth, int screenHeight) : isExitRequested_(false), name_(name), dLight_(this), frameCount_(0)
{
...
ID3D11ShaderResourceView* Game::GetCsm()
{
	return depthShadowSrv_.Get();
}

ID3D11Buffer* const* Game::GetPerSceneCb()
{
